...
declare module '#imports' {
  ...
  export { parseOpenAIError, parseClaudeError, TranscriptionError, TranscriptionError, formatTranscriptionError } from '../src/utils/apiErrors';
  export { verifyApiKey } from '../src/utils/apiKeyVerifier';
  export { parseProcessedResponse } from '../src/utils/responseParser';
  export { renderTemplate, defaultTemplates } from '../src/utils/template';
}
